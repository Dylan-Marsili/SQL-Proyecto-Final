...
VALUES 
    (null, 'Toluca', 50100, 'Estado de México', 'México'),
    (null, 'Monclova', 25700, 'Coahuila', 'México'),
    (null, 'Zacatecas', 98000, 'Zacatecas', 'México'),
    (null, 'Aguascalientes', 20000, 'Aguascalientes', 'México'),
    (null, 'Ensenada', 22800, 'Baja California', 'México'),
    (null, 'San Juan del Río', 76800, 'Querétaro', 'México'),
    (null, 'Reynosa', 88700, 'Tamaulipas', 'México'),
    (null, 'Guaymas', 85400, 'Sonora', 'México'),
    (null, 'La Paz', 23000, 'Baja California Sur', 'México'),
    (null, 'Matamoros', 87300, 'Tamaulipas', 'México'),
    (null, 'Los Mochis', 81200, 'Sinaloa', 'México'),
    (null, 'Nuevo Laredo', 88000, 'Tamaulipas', 'México'),
    (null, 'Coatzacoalcos', 96400, 'Veracruz', 'México'),
    (null, 'Uruapan', 60000, 'Michoacán', 'México'),
    (null, 'Irapuato', 36600, 'Guanajuato', 'México'),
    (null, 'Chilpancingo', 39000, 'Guerrero', 'México'),
    (null, 'Tampico', 89100, 'Tamaulipas', 'México'),
    (null, 'Torreón', 27000, 'Coahuila', 'México'),
    (null, 'Mazatlán', 82000, 'Sinaloa', 'México'),
    (null, 'Orizaba', 94300, 'Veracruz', 'México'),
    (null, 'Cozumel', 77600, 'Quintana Roo', 'México'),
    (null, 'Pachuca', 42000, 'Hidalgo', 'México'),
    (null, 'Manzanillo', 28200, 'Colima', 'México'),
    (null, 'Tlaxcala', 90000, 'Tlaxcala', 'México'),
    (null, 'Celaya', 38000, 'Guanajuato', 'México'),
    (null, 'Cuautla', 62740, 'Morelos', 'México'),
    (null, 'Puerto Vallarta', 48300, 'Jalisco', 'México'),
    (null, 'Tlalnepantla', 54000, 'Estado de México', 'México'),
    (null, 'Saltillo', 25100, 'Coahuila', 'México');

           
           
INSERT INTO departamentos (id_department, department_name, department_description)
VALUES (null, 'Marketing', 'Departamento encargado de la promoción y estrategia publicitaria de la empresa'),
       (null, 'Finanzas', 'Equipo a cargo de la gestión financiera, presupuesto y análisis económico de la empresa'),
       (null, 'Legal', 'Departamento responsable de los asuntos legales y cumplimiento normativo'),
       (null, 'Innovación', 'Equipo encargado de la investigación y desarrollo de nuevos productos y servicios'),
       (null, 'Soporte Técnico', 'Departamento que brinda asistencia técnica a clientes y personal interno'),
       (null, 'Dirección General', 'Equipo encargado de la dirección estratégica y liderazgo de la empresa');

INSERT INTO rangos (id_rank, rank_name_hierarchy, salary_floor, salary_ceiling)
VALUES  (null, 'asistente de marketing', 7000, 11000),
        (null, 'analista financiero', 10000, 15000),
        (null, 'abogado corporativo', 12000, 18000),
        (null, 'especialista en innovación', 15000, 22000),
        (null, 'coordinador de soporte', 8000, 13000),
        (null, 'gerente de finanzas', 16000, 25000),
        (null, 'director de marketing', 20000, 30000),
        (null, 'director de innovación', 25000, 35000),
        (null, 'director legal', 18000, 28000),
        (null, 'CEO', 30000, 50000);

INSERT INTO puestos (id_position, position_name, id_rank, id_department)
VALUES  (null, 'CEO', 10, 6),
        (null, 'asistente de marketing', 1, 1),
        (null, 'analista de marketing', 2, 1),
        (null, 'gerente de marketing', 6, 1),
        (null, 'coordinador de finanzas', 5, 2),
        (null, 'analista financiero', 2, 2),
        (null, 'director financiero', 7, 2),
        (null, 'abogado corporativo', 3, 3),
        (null, 'especialista en innovación', 4, 4),
        (null, 'gerente de innovación', 6, 4),
        (null, 'coordinador de soporte', 5, 5),
        (null, 'técnico de soporte', 3, 5),
        (null, 'director de soporte', 7, 5),
        (null, 'director legal', 9, 3),
        (null, 'asistente legal', 1, 3),
        (null, 'coordinador de innovación', 4, 4),
        (null, 'analista de innovación', 2, 4),
        (null, 'especialista en soporte', 4, 5),
        (null, 'coordinador de legal', 5, 3),
        (null, 'especialista en marketing', 4, 1),
        (null, 'gerente de legal', 6, 3),
        (null, 'especialista financiero', 4, 2);
